...
// $url .= ""
// echo httpGet($output);
// $source = YouTube::getSource("https://www.youtube.com/watch?v=Fzzj5MshwCk");
...
var_dump($matches);
var_dump($matches[0]);
var_dump($value = preg_replace('/"ttsurl".*?"/', NULL, $matches[0]));
var_dump($value = preg_replace('/"/', NULL, $value[0]));
// echo $value[];
// var_dump($matches[1]);
echo $value;
?>